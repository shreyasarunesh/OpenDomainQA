...
class TextPreProcessor:
    ...
    '''
     *
     *  Summary : This function removes all the stopwords.  
     *
    ...
    '''
     *
     *  Summary : This function iterates through the stem words and returns the removes the sufix and prefix.
     *
    ...
    def stem_text(self, text_data):
        cleaned_text = self.stem_words.stemWords(text_data)
